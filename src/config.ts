...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/kWyiw", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://x.com/Tendust_yiw",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/id/Tendust/",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/kWyiw",
		},
	],
};
